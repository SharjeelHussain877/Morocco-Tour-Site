...
const obj = [
    {
        id: 1234,
        image: "https://awesomemoroccotours.com/destinations/marrakech//images/316273400%20(1).jpg",
    ...
    {
        id: 1234,
        image: "https://awesomemoroccotours.com/destinations/marrakech/images/marrakech-areas.jpg",
    ...
    {
        id: 1234,
        image: "https://awesomemoroccotours.com/destinations/marrakech/images/f4.jpg",
            ...
            <div class="package-item">
              ...
              <div class="d-flex border-bottom">
                ...
                <small class="flex-fill text-center py-2 text-capitalize"
                  ><i class="fa fa-user text-primary me-2"></i>${el.night} ${el.day == 1 ? "night" : "nights"}</small  
                >
              </div>
...
const removeElems =[`<div class="mb-3">
                  <small class="fa fa-star text-primary"></small>
                  <small class="fa fa-star text-primary"></small>
                  <small class="fa fa-star text-primary"></small>
                  <small class="fa fa-star text-primary"></small>
